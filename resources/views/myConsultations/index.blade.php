                                       ...
                                       <!-- Dropdown ar konsultācijām -->
                                        ...
                                        <select id="new_consultation-{{ $consultation->id }}" name="new_consultation_id" required>
                                            ...
                                            <option value="{{ $consultation->id }}" selected>
                                                {{ $consultation->date_time->format('d.m.Y H:i') }} (jūsu izvēle)
                                            </option>

                                            <!-- Pieejamās citas konsultācijas no tā paša pasniedzēja -->
                                            @foreach($availableConsultationsByTeacher[$consultation->id] ?? [] as $available)
                                                @if($available->id !== $consultation->id)
